...
- query는 쿠팡에서 실제 소비자용 상품이 나올 만한 검색어로 쓰세요. B2B 설비, 정책, 투자, 시스템, 솔루션처럼 상품 검색 품질이 낮은 단어는 피하세요.
- 관련 소비재가 애매하면 도서, 입문서, 굿즈, 생활용품, 전자기기 액세서리처럼 안전한 탐색형 상품군만 제안하세요.
- commerceHints는 구체 상품명을 꾸며내지 말고 검색 의도만 제안하세요.
- 좋은 commerceHints.query 예: "AI 입문서", "반도체 투자 책", "축구 국가대표 유니폼", "여론조사 책"
- 나쁜 commerceHints.query 예: "데이터센터 냉각 시스템", "정부 정책 솔루션", "AI 인프라 투자"
