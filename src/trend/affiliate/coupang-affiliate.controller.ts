...
import {
  CreateCoupangDeeplinkDto,
  SearchCoupangProductsDto,
} from './dto/create-coupang-deeplink.dto';
...
export class CoupangAffiliateController {
  ...
  @Post('products')
  async searchProducts(@Body() body: SearchCoupangProductsDto) {
    return this.coupangAffiliateService.searchProducts(body.query, body.limit);
  }
}
